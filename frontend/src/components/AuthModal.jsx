          ...
          >
            ...
            <div className="relative">
              ...
              <form onSubmit={submit} className="space-y-6 sm:space-y-8">
                  ...
                  {mode === 'signup' && (
                    <div className="relative group">
                      ...
                      <input
                        ...
                        autoComplete="name"
                        className="w-full pl-12 pr-4 py-3.5 sm:py-4 rounded-2xl border-2 border-gray-50 bg-gray-50 focus:bg-white focus:border-pink-200 focus:ring-4 focus:ring-pink-500/5 outline-none transition-all font-bold text-base"
                      />
                    </div>
                  )}
                ...
                {authError && (
                  <div className="p-4 rounded-2xl bg-red-50 text-red-600 text-xs font-bold border border-red-100 flex flex-col gap-2">
